...
void FBP2AIModule::RegisterMenus()
{
    ...
    if (BlueprintToolbar)
    {
        ...
        UE_LOG(LogBP2AI, Log, TEXT("BP2AI: Registered button in Blueprint Editor toolbar"));
    }
    else
    {
        UE_LOG(LogBP2AI, Warning, TEXT("BP2AI: Failed to extend Blueprint Editor toolbar"));
    }
    ...
    if (WidgetToolbar)
    {
        ...
        UE_LOG(LogBP2AI, Log, TEXT("BP2AI: Registered button in Widget Blueprint Editor toolbar"));
    }
    else
    {
        UE_LOG(LogBP2AI, Warning, TEXT("BP2AI: Failed to extend Widget Blueprint Editor toolbar"));
    }
}
/* --- COMMENTED OUT LEGACY IMPLEMENTATION ---
