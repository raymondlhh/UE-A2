...
#define DEV_COMPILE_TIME_VERBOSITY_LogBP2AI NoLogging
#define DEV_COMPILE_TIME_VERBOSITY_LogBlueprintNodeFactory NoLogging 
#define DEV_COMPILE_TIME_VERBOSITY_LogDataTracer NoLogging  
#define DEV_COMPILE_TIME_VERBOSITY_LogPathTracer NoLogging    
#define DEV_COMPILE_TIME_VERBOSITY_LogFormatter NoLogging  
#define DEV_COMPILE_TIME_VERBOSITY_LogUI NoLogging         
#define DEV_COMPILE_TIME_VERBOSITY_LogExtractor NoLogging      
#define DEV_COMPILE_TIME_VERBOSITY_LogModels NoLogging
#define DEV_COMPILE_TIME_VERBOSITY_LogBlueprintMarkdownHTML NoLogging
